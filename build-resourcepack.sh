...
echo -e "${GREEN}Building ValeWaypoints Resource Pack...${NC}"

# Check if texture exists
texture_path="resourcepack/assets/minecraft/textures/item/valewaypoints_token.png"
...
pack_name="ValeWaypoints-ResourcePack-$version.zip"
