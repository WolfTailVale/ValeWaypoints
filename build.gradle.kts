...
description = "ValeWaypoints - Banner waypoints for Minecraft servers"

// Print version info
println("Building ValeWaypoints version: $version")
...
tasks {
    ...
    processResources {
        ...
        val pluginProperties = mapOf(
            ...
            "website" to "github.com/WolfTailVale/ValeWaypoints",
            "depend" to listOf("ProtocolLib"),
            "prefix" to "ValeWaypoints",
        )
