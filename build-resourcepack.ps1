# ValeWaypoints Resource Pack Builder
# Creates a zip file ready for distribution

Write-Host "Building ValeWaypoints Resource Pack..." -ForegroundColor Green

# Check if texture exists
$texturePath = "resourcepack\assets\minecraft\textures\item\valewaypoints_token.png"
...
$packName = "ValeWaypoints-ResourcePack-$version.zip"
