...
public class CampBannerMap {
    ...
    private final Map<Location, CampStructure> campStructures = new HashMap<>();
    ...
    public void removeCampBanner(Location location) {
        ...
        // Also remove and cleanup any associated camp structure
        CampStructure structure = campStructures.remove(location);
        if (structure != null) {
            structure.removeCampStructure();
        }
    }

    /**
     * Associates a camp structure with a banner location
     */
    public void addCampStructure(Location bannerLocation, CampStructure structure) {
        campStructures.put(bannerLocation, structure);
    }

    /**
     * Gets the camp structure associated with a banner location
     */
    public CampStructure getCampStructure(Location bannerLocation) {
        return campStructures.get(bannerLocation);
    }
